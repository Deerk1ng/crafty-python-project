...
def seed_products():
    products = {
        "Men's Genuine Leather Medival Belt": {"ownerId": 1, "price": 140.00, "description": "Elevate your historical ensemble with our Medieval Men's Belt, a perfect fusion of functionality and authentic medieval craftsmanship. Designed for those who appreciate the finer details of historical attire, this belt offers a rugged yet refined addition to any medieval or fantasy wardrobe.", "category": 'mens'},
        "Ranger's Cloak": {"ownerId": 5, "price": 75.00, "description": "Step into the heart of adventure with our Ranger's Cloak, a masterfully crafted garment designed for the modern explorer and fantasy enthusiast. Combining practical functionality with an air of mystique, this cloak is an essential companion for those who roam the wilds or seek to embody the spirit of legendary rangers.", "category": 'mens'},
        "Men's Genuine Wool Tunic": {"ownerId": 5, "price": 34.90, "description": "Discover timeless style and unparalleled comfort with our Men's Tunic, a versatile garment that seamlessly blends historical charm with modern practicality. Whether you're attending a medieval reenactment, a renaissance fair, or simply looking to enhance your everyday wardrobe, this tunic is designed to make a statement.", "category": 'mens'},
        "Longsword": {"ownerId": 5, "price": 140.00, "description": "Command respect and exude strength with our Longsword, a masterfully crafted weapon that blends historical accuracy with exceptional functionality. Designed for collectors, reenactors, and martial artists alike, this long sword is a testament to both form and function, ensuring you stand out in any setting.", "category": 'melee'},
        "Dagger": {"ownerId": 5, "price": 28.00, "description": "Unveil the elegance and utility of our meticulously crafted Dagger, a versatile tool designed for both collectors and practitioners. Whether you're enhancing your historical reenactment gear, embarking on a role-playing adventure, or simply appreciating fine craftsmanship, this dagger stands as a testament to timeless design and functionality.", "category": 'melee'},
        "Medival Dress": {"ownerId": 5, "price": 90.00, "description": "Step into a world of timeless elegance with our Women's Medieval Dress, a stunning garment designed to capture the essence of historic beauty and sophistication. Perfect for reenactments, renaissance fairs, or themed events, this dress seamlessly blends authentic medieval design with modern comfort.", "category": 'womens'},
        "Elven Cuffs": {"ownerId": 5, "price": 14.90, "description": 'Unleash your inner elf with our exquisite Elven Cuffs, a beautifully crafted accessory that embodies the grace and elegance of elven craftsmanship. Perfect for fantasy enthusiasts, LARP events, or renaissance fairs, these cuffs add a touch of ethereal charm to any outfit.', "category": 'womens'},
        "Elven Purse": {"ownerId": 5, "price": 20.00, "description": "Inspired by the ethereal beauty of elven craftsmanship, the purse features delicate, nature-inspired motifs, such as intricately embossed leaf patterns and graceful vine designs. The ornate detailing creates a sense of enchantment, capturing the essence of elven elegance.", "category": 'womens'},
        "Viking Throwing Axe": {"ownerId": 6, "price": 132.00, "description": "The Viking Throwing Axe features a classic, battle-hardened design inspired by historical Viking weaponry. Its robust head, often adorned with Norse runes or intricate engravings, reflects the iconic style of Viking axes used in combat and ceremonial practices.", "category": 'long-range'},
        "Medival Mace": {"ownerId": 6, "price": 28.00, "description": "Unleash unparalleled power and authority with our Medieval Mace, a formidable weapon that epitomizes strength and craftsmanship. Designed for reenactors, collectors, and historical enthusiasts, this mace combines historical accuracy with exceptional functionality, making it a standout piece in any medieval armory.", "category": 'melee'},
        "Archer's Bow and Arrows Set": {"ownerId": 6, "price": 77.50, "description": "Step into a realm of fantasy and precision with our Elven Bow and Arrow Set, a masterfully crafted weaponry ensemble designed to captivate and perform. Whether you're a seasoned archer, a fantasy enthusiast, or preparing for a themed event, this set combines elegant craftsmanship with exceptional functionality, transporting you to an enchanting world.", "category": 'long-range'},
        "Mana Vials": {"ownerId": 6, "price": 19.00, "description": "Unlock the magic of your fantasy adventures with our exquisitely crafted Mana Vials, an essential accessory for role-players, collectors, and fantasy enthusiasts. Designed to capture the essence of magical potency, these vials are perfect for adding an element of mystique to your cosplay, LARPing events, or display collection.", "category": 'accessories'},
        "The Judge's Crossbow": {"ownerId": 6, "price": 64.00, "description": "Command authority and precision with the Judge's Crossbow, a meticulously crafted weapon that combines historical elegance with formidable power. Designed for collectors, reenactors, and enthusiasts, this crossbow stands as a symbol of medieval might and judicial gravitas, offering both impressive functionality and aesthetic appeal.", "category": 'long-range'},
        "Viking Shield": {"ownerId": 6, "price": 139.90, "description": "Command the battlefield and showcase your warrior spirit with our Viking Shield, a robust and meticulously crafted piece designed to embody the strength and valor of Viking warriors. Perfect for historical reenactments, fantasy events, or as a striking display item, this shield combines historical authenticity with impressive functionality.", "category": 'accessories'},
        "Ranger's Genuine Leather Boots": {"ownerId": 6, "price": 149.90, "description": "Crafted from premium leather or high-performance synthetic materials, Ranger's Boots are designed to endure the demands of the wild. The sturdy, weather-resistant construction ensures longevity and protection in various conditions, from rugged trails to urban environments.", "category": 'accessories'}
    }
